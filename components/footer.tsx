...
import { companyInfo as fallbackCompany, siteImages as fallbackSiteImages } from '@/lib/data'
...
export function Footer() {
  const [site, setSite] = useState({ companyInfo: fallbackCompany, siteImages: fallbackSiteImages })
  const { companyInfo, siteImages } = site
          ...
          <div>
            <div className="flex items-center gap-3">
              <div className="relative h-12 w-12 overflow-hidden rounded-full bg-white">
                <Image
                  src={siteImages.logo}
                  alt={`${companyInfo.fullName || 'PHIJETH KONSTRUCTION'} logo`}
                  fill
                  sizes="48px"
